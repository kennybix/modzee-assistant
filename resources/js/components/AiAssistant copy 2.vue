...
:root {
  ...
  --gradient-start: #FFDAB9; /* Light peach */
  --gradient-end: #FFC0CB;   /* Light pink */
  --container-bg: #FFFFFF;
  --text-primary: #333333;
  ...
  --input-border: #D0D0D0;
  --input-bg: #FFFFFF;
  --user-message-bg: linear-gradient(135deg, #E6F7FF, #CCEDFF); /* Subtle gradient */
  --ai-message-bg: linear-gradient(135deg, #F0FFF0, #DFFFD9);  /* Subtle gradient */
  --accent-blue: #1890ff;
  --error-bg: #FFF1F0;
  --error-text: #D93026;
...
/* Chat bubble “tail” effect using border-radius tweaks */
...
.ai-message .message-sender { color: #389e0d; }
.message-content {
  font-size: 0.95em;
  line-height: 1.6;
...
.markdown-content h1, .markdown-content h2, .markdown-content h3 { margin: 1em 0 0.5em; line-height: 1.3; }
